...
<html lang="en">
  <head>
    ...
    <title>PGDI Admin - Painel de Administardor</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">PGDI</a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user">
        <div>
          <p class="app-sidebar__user-name">BV</p>
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Dados Mensais</h3>
        ...
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Dados Departamentais</h3>
            <div class="embed-responsive embed-responsive-16by9">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Resumo do Relatório</h3>
          <p><strong>Data do Relatório:</strong> <?php // Data do relatório, pode ser a data atual ?></p>
          <p><strong>Quantidades de Chefes de Departamento:</strong> <?php // Código PHP para contar os chefes de departamento ?></p>
          <p><strong>Quantidades de Funcionários:</strong> <?php // Código PHP para contar os funcionários ?></p>
          <p><strong>Quantidades de Documentos:</strong> <?php // Código PHP para contar os documentos ?></p>
          <p><strong>Quantidades de Notificações:</strong> <?php // Código PHP para contar as notificações ?></p>
          <p><strong>Quantidades de Funcionários em Cada Departamento:</strong> <?php // Código PHP para listar a quantidade de funcionários por departamento ?></p>
          <p><strong>Chefes de Departamentos Mencionados em Seus Departamentos:</strong> <?php // Código PHP para listar os chefes de departamento mencionados ?></p>

          <button class="btn-download" onclick="downloadPDF()">Baixar Relatório em PDF</button>
          </div>
        </div>

        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Comp</h3>
          <p><strong>Data do Relatório:</strong> <?php // Data do relatório, pode ser a data atual ?></p>
          <p><strong>Quantidades de Chefes de Departamento:</strong> <?php // Código PHP para contar os chefes de departamento ?></p>
          <p><strong>Quantidades de Funcionários:</strong> <?php // Código PHP para contar os funcionários ?></p>
          <p><strong>Quantidades de Documentos:</strong> <?php // Código PHP para contar os documentos ?></p>
    ...
    <script type="text/javascript">
      ...
      function downloadPDF() {
        ...
        doc.text("Data do Relatório: <?php // Data do relatório ?>", 20, 30);
        doc.text("Quantidades de Chefes de Departamento: <?php // Quantidade de chefes ?>", 20, 40);
        doc.text("Quantidades de Funcionários: <?php // Quantidade de funcionários ?>", 20, 50);
        doc.text("Quantidades de Documentos: <?php // Quantidade de documentos ?>", 20, 60);
        doc.text("Quantidades de Notificações: <?php // Quantidade de notificações ?>", 20, 70);
        doc.text("Quantidades de Funcionários em Cada Departamento: <?php // Funcionários por departamento ?>", 20, 80);
        doc.text("Chefes de Departamentos Mencionados em Seus Departamentos: <?php // Chefes mencionados ?>", 20, 90);
