      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              <form action="ConfigRegistroDepart.php" method="POST">
                ...
                <div class="form-group">
                  <label class="control-label">Chefe de Departamento</label>
                  <select class="form-control" id="chefeDep" name="chefe">
                    <?php // Código PHP para listar os chefes de departamento ?>
                </select>
                </div>
                <div class="form-group">
              ...
              <button class="btn btn-info" name="criar" type="submit" id="demoSwal"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>
            </div>
              </form>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  $('#demoSwal').click(function(){
    swal({
      ...
      text: "Desejas registrar esse Departamento!",
      type: "warning",
      ...
      if (isConfirm) {
        swal("Registrado!", "Departamento Registrado.", "success");
      } else {
        swal("Cancelado", "Departamento Cancelado )", "error");
      }
    });
  });
</script>
