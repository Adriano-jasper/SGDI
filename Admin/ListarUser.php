  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="charts.html"><i class="app-menu__icon fa fa-sitemap"></i><span class="app-menu__label">Departamentos</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Listar Usuário</h1>
        ...
        <div class="col-md-12">
          ...
          ?>
                ...
                <tr>
                    ...
                    <td><?php echo $dados['Permissao']; ?></td>
                    <td class="actions">
                      <button style="background-color: #00467f; color: white; cursor: pointer; border: none;"> <a href="EditarUser.php?Id=<?php echo $dados['Id']?>"> <i class="fa fa-pencil-square-o"aria-hidden="true"> </i></button>
                     
                      <form action="Delete.php" method="POST">
                        <input type="hidden" name="id" value="<?php echo $dados['Id']; ?>">
                        <button type="submit" style="background-color: #00467f; color: white; cursor: pointer; border: none;" name="deletar"> <i class="fa fa-trash-o" aria-hidden="true"> </i></button>
                      </form>
                    </td>
                </tr>
                <?php endwhile; ?>  
