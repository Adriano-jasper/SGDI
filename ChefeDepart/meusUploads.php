        ...
        <div class="col-md-12">
          ...
          ?>
                ...
                <tr>
                    ...
                    <td> 
                      <button style="background-color: #00467f; color: white; cursor: pointer; border: none;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                      <button style="background-color: #00467f; color: white; cursor: pointer; border: none;"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                      <button style="background-color: #00467f; color: white; cursor: pointer; border: none;"><i class="fa fa-share" aria-hidden="true"></i></button>
                    </td>
                </tr>
                <?php endwhile; ?>  
                  <!--<td>1</td>
                    ...
                    <td>2025-01-18</td>
                    <td class="actions">
                        <button style="background-color: #00467f; color: white; cursor: pointer; border: none;"><i class="fa fa-eye" aria-hidden="true"></i></button>
                        <button style="background-color: #00467f; color: white; cursor: pointer; border: none;"><i class="fa fa-download" aria-hidden="true"></i></button>
                        <button style="background-color: #00467f; color: white; cursor: pointer; border: none;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                        <button style="background-color: #00467f; color: white; cursor: pointer; border: none;"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                    </td>-->
                </tbody>
