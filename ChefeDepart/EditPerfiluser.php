...
<html lang="en">
  <head>
    ...
    <title>Perfil do Usuário - PGDI Admin</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="listarMembros.php"><i class="app-menu__icon fa fa-user-plus"></i><span class="app-menu__label">Membros</span></a></li>
