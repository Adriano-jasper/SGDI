  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="upload.php"><i class="app-menu__icon fa fa-user-plus"></i><span class="app-menu__label">Adicionar Usuário</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Adição de Usuário</h1>
          <p>PGDI</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">PGDI</li>
          <li class="breadcrumb-item"><a href="#">Adição de Usuário</a></li>
        </ul>
      </div>
      <div class="row">
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
            <h3 class="tile-title">Adicionar Usuário no meu Departamento</h3>
            <hr>
          ...
          ?>
                ...
                <tr>
                    ...
                    <td class="actions">
                      ...
                      <button style="background-color: #00467f; color: white; cursor: pointer; border: none;"><i class="fa fa-user-plus" aria-hidden="true"></i></button>
                    </td>
                </tr>
                <?php endwhile; ?>  
                </tbody>
...
<script type="text/javascript">
  ...
  $('#demoSwal').click(function(){
    swal({
      ...
      text: "Desejas adicionar esse(s) Usuário(s)?",
      type: "warning",
      ...
      if (isConfirm) {
        swal("Adicionado!", "Usuário Adicionado.", "success");
      } else {
