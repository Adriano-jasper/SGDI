...
<body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user">
         ...
         <div class="app-menu">
            ...
            <li><a class="app-menu__item active" href="DocumentosDoMeuDepartamento.php"><i class="app-menu__icon fa fa-share-alt"></i><span class="app-menu__label">Documentos Compartilhados</span></a></li>
    ...
    <main class="app-content">
        ...
        <div class="row">
            ...
            // Verificar permissões do usuário (visualizar e download)
            $sql_permissoes = "SELECT p.Tipo, up.Estado 
                               FROM usuario_permissoes up 
                               JOIN permissoes p ON up.Id_permissao = p.Id 
                               WHERE up.Id_usuario = '$id' 
                               AND (p.Tipo = 'visualizar' OR p.Tipo = 'Download')";
            $result_permissoes = mysqli_query($mysqli, $sql_permissoes);

            $pode_visualizar = false;
            $pode_download = false;

            while($permissao = mysqli_fetch_assoc($result_permissoes)) {
                if($permissao['Tipo'] == 'visualizar' && $permissao['Estado'] == 1) {
                    $pode_visualizar = true;
                }
                if($permissao['Tipo'] == 'Download' && $permissao['Estado'] == 1) {
                    $pode_download = true;
                }
            }
