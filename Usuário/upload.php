      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="#"><i class="logout.php"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </header>
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Fazer Upload</a></li>
        </ul>
      </div>
      <div class="row">
        </div>
            ...
            <div class="tile-body">
                <form class="form-horizontal">
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" placeholder="Nome do documento">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="control-label col-md-3">Descrição</label>
                    <div class="col-md-8">
                      <textarea class="form-control" rows="4" placeholder="Descrição do Documento"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
