  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <?php
          if($dados['Id_Departamento'] != NULL ):
        echo '<li><a class="app-menu__item" href="upload.php"><i class="app-menu__icon fa fa-upload"></i><span class="app-menu__label">Fazer Uploads</span></a></li>';
        echo '<li><a class="app-menu__item" href="meusUploads.php"><i class="app-menu__icon fa fa-clipboard"></i><span class="app-menu__label">Meus Uploads</span></a></li>';
        echo '<li><a class="app-menu__item" href="DocumentosDoMeuDepartamento.php"><i class="app-menu__icon fa fa-files-o"></i><span class="app-menu__label">Documentos</span></a></li>';
          endif;?>
    ...
    <main class="app-content">
      ...
      <div class="perfil">
        <img src="Fotos/<?php echo $dados['Caminho_da_Ft']?>">
    </div>
    <br>
                  <div class="profile-container">
                     <div class="profile-field">
                        <label>Nome Completo:</label>
                          <p style="color:blue"><?php echo $dados['Nome'] ?></p>
                      </div>
                      <div class="profile-field">
                        <label>Email:</label>
                           <p style="color:blue"><?php echo $dados['Email']  ?></p>
                      </div>
                      <div class="profile-field">
                         <label>Senha:</label>
                             <p style="color:blue"><?php echo $dados['Senha']  ?></p>
                      </div>
                      <div class="profile-field">
                         <label>Telefone:</label>
                           <p style="color:blue"><?php echo $dados['Telefone']  ?></p>
                           <p style="color:blue"><?php echo $dados['Caminho_da_Ft']  ?></p>
                      </div>
                  </div>
                </div>                
              </div>
            ...
            <div class="tab-pane fade" id="user-settings">
              <div class="tile user-settings">
                ...
                <form action="ConfigEditarPerfil.php" method="POST" enctype="multipart/form-data">
                <input type="hidden"name ='id' value=<?php echo $dados['Id'] ?> >
                  <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                      <label>Senha</label>
                      <input class="form-control" type="password" name="senha" value=<?php echo $dados['Senha'] ?>>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-8 mb-4">
                      <label>Telefone</label>
                      <input class="form-control" type="number" name="telefone" value=<?php echo $dados['Telefone'] ?>>
                    </div>
